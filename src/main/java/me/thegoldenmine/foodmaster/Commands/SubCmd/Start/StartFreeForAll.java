...
public class StartFreeForAll {
    private final FoodMaster plugin;

    public StartFreeForAll(FoodMaster main) {
        plugin = main;
    }
    ...
    public void startFreeForAll(Player player, String args) {
            ...
            for (UUID uuids : group) {
                ...
                if (players != null) {
                    ...
                    if (!players.equals(player)) {
                        ...
                        players.sendMessage(INFO + " You started " + gold + "" + italic + "Free For All" + aqua + "" + italic + ".");
                    }
