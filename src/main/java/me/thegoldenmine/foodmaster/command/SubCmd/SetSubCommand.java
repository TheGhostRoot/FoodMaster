...
public class SetSubCommand {
    ...
    public SetSubCommand(FoodMaster main) {
        plugin = main;
        ...
        if (args[1].equalsIgnoreCase("game-time")) {
            ...
            if (args.length == 3) {
                try {
                    ...
                    player.sendMessage(NORMAL + "You have set game time to " + gold + "" + italic + "" + time + "" + green + "" + italic + " seconds. " + gold + "" + "" + italic + "" + plugin.time.getTime(time));
