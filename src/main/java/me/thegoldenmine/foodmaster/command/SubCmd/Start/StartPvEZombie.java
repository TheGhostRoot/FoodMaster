...
public class StartPvEZombie {
    private final FoodMaster plugin;

    public StartPvEZombie(FoodMaster main) {
        plugin = main;
    }
    ...
    public void startPvEZombie(Player player, String args) {
            ...
            for (UUID uuids : group) {
                ...
                if (players != null) {
                    ...
                    if (!players.equals(player)) {
                        ...
                        players.sendMessage(INFO + " You started " + gold + "" + italic + "PvE Zombie boss" + aqua + "" + italic + ".");
                    }
