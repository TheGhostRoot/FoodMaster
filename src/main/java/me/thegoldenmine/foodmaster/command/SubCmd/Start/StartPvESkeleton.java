...
public class StartPvESkeleton {
    private final FoodMaster plugin;

    public StartPvESkeleton(FoodMaster main) {
        plugin = main;
    }
    ...
    public void startPvESkeleton(Player player, String args) {
            ...
            for (UUID uuids : group) {
                ...
                if (players != null) {
                    ...
                    if (!players.equals(player)) {
                        ...
                        players.sendMessage(INFO + " You started " + gold + "" + italic + "PvE Skeleton boss" + aqua + "" + italic + ".");
                    }
