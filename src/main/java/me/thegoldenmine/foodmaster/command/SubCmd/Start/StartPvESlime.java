...
public class StartPvESlime {
    private final FoodMaster plugin;

    public StartPvESlime(FoodMaster main) {
        plugin = main;
    }
    ...
    public void startPvESlime(Player player, String args) {
            ...
            for (UUID uuids : group) {
                ...
                if (players != null) {
                    ...
                    if (!players.equals(player)) {
                        ...
                        players.sendMessage(INFO + " You started " + gold + "" + italic + "PvE Slime boss" + aqua + "" + italic + ".");
                    }
